      ...
      <div className="relative max-w-md">
        ...
        >
          <img
            ...
            className="w-full h-auto rounded-lg ring-1 ring-gray-200 shadow-elevation-2 transition-shadow duration-200 group-hover:shadow-elevation-3"
          />
          {!processing && (
        ...
        {processing && (
          <div className="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center rounded-lg">
            <div className="text-center">
              ...
              <p className="font-medium text-gray-900">Processing receipt...</p>
              <p className="text-sm text-gray-500">Extracting expense data with OCR</p>
            </div>
          </div>
        )}
      </div>
